 ...
 * 
 */
@WebServiceClient(name = "MD5ImplService", targetNamespace = "http://localhost:8080/MD5", wsdlLocation = "http://localhost:8080/MD5?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MD5IMPLSERVICE_QNAME = new QName("http://localhost:8080/MD5", "MD5ImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/MD5?wsdl");
    ...
    public MD5Impl getMD5ImplPort() {
        return super.getPort(new QName("http://localhost:8080/MD5", "MD5ImplPort"), MD5Impl.class);
    }
     ...
     */
    @WebEndpoint(name = "MD5ImplPort")
    public MD5Impl getMD5ImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://localhost:8080/MD5", "MD5ImplPort"), MD5Impl.class, features);
    }
